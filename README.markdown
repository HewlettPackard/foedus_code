...
* foedus-core : The main library client programs would link to.
...
* tests-[core/util/rdb] : Unit testcase projects for each project.
* experiments-[core/util/rdb] : Performance experiments projects for each project.
