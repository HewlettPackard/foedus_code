 ...
 */
#ifndef FOEDUS_TPCE_TPCE_DRIVER_HPP_
#define FOEDUS_TPCE_TPCE_DRIVER_HPP_
...
/**
 * @brief Main class for TPCE benchmark.
 */
class TpceDriver {
 public:
  enum Constants {
  ...
  explicit TpceDriver(Engine* engine) : engine_(engine) {
  }
...
#endif  // FOEDUS_TPCE_TPCE_DRIVER_HPP_
