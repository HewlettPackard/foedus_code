...
echo "extended_rw_lock=$extended_rw_lock, enable_retrospective_lock_list=$enable_retrospective_lock_list, parallel_lock=$parallel_lock"
echo "extra_table_size=$extra_table_size, extra_table_rmws=$extra_table_rmws, extra_table_reads=$extra_table_reads"
