...
void EpochMarkerLogType::apply_engine(const xct::XctId &/*xct_id*/, thread::Thread* context) {
  log::Logger &logger = context->get_engine()->get_log_manager().get_logger(logger_id_);
